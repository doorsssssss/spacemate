package com.spacemate.common.error;
...
public enum ErrorCode {
    ...
    ZGID_EXISTS("ZGID_EXISTS", "管理员账号已存在"),
    VERIFICATION_RATE_LIMIT("VERIFICATION_RATE_LIMIT", "验证码发送过于频繁"),
    VERIFICATION_DAILY_LIMIT("VERIFICATION_DAILY_LIMIT", "验证码发送已达当日上限"),
    ...
    PASSWORD_POLICY_VIOLATION("PASSWORD_POLICY_VIOLATION", "密码不符合策略"),
    TERMS_NOT_ACCEPTED("TERMS_NOT_ACCEPTED", "未同意服务协议"),
